Some of the code from a project based on the Mars Rover. A Raspberry Pi was placed on a 6 wheel Rover Buggy chasis. A JavaScript server runs and listens for commands from a C# application running on 
